...
validaciones_tec = [dict(cabecera='CODIGO DEL ASESOR', col='A', tipo='usuario'),
                    ...
                    dict(cabecera='NOMBRE DEL CLIENTE', col='L', tipo='texto_none'),
                    dict(cabecera='NRO° TELFONO DEL QUE LLAMA (MSISDN )', col='M', tipo='telf'),
                    dict(cabecera=' NRO°  INDENTIFICADO  (TELEFONO EN CONSULTA)', col='N', tipo='telf'),
                    dict(cabecera='TIPO DE LLAMADA', col='O', tipo='tipo_llamada'),
