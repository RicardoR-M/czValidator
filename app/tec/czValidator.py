...
from app.tec.conf import sheet_name, col_fecha_monitoreo, col_fecha_llamada
from app.tec.plantillas import ErrorValidacion
from app.tec.validaciones import usuario, texto, fecha, numero, no_vacio, monitor_cz, sino, fcr, no_si, detalle_nofcr, vacio, obs_recomendacion, sn, fechas_cz
